...
namespace ECommerce.Presistence.IdentityData.Migrations
{
    ...
    [Migration("20260111162057_Add OTP and expire date to identity db context2")]
    partial class AddOTPandexpiredatetoidentitydbcontext2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Doamin.Entities.IdentityModule.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ECommerce.Doamin.Entities.IdentityModule.ApplicationUser", null)
                        .WithMany()
